...
class LoginPage(BasePage):
    ...
    def should_be_login_form(self):
        ...
        assert self.is_element_present(*LoginPageLocators.LOG_SUBMIT), "Login form is not presented"

    def should_be_register_form(self):
        assert self.is_element_present(*LoginPageLocators.REG_SUBMIT), "Registration form is not presented"
